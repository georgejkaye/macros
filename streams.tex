...
\newcommand{\fcstream}[1]{\mathbf{FCStream}_{#1}}
\newcommand{\fcstreami}{\fcstream{\interpretation}}

% generators of stream function category
\newcommand{\copystream}{{\mathsf{c}}}
\newcommand{\joinstream}{{\mathsf{j}}}
\newcommand{\stubstream}{{\mathsf{s}}}
\newcommand{\shiftstream}{{\delta}}
...
\NewDocumentCommand\circuittomealy{om}{%
    \left\llbracket\IfValueTF{#1}{#1}{-}\right\rrbracket_{#2}%
}
