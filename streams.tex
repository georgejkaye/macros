...
\newcommand{\mealyfunctionoutput}[1]{#1_O}
\newcommand{\mealyfunctiontransition}[1]{#1_T}
\newcommand{\transitionafter}[2]{T_{#1,#2}}


\NewDocumentCommand\streaminit{o}{\mathsf{i}\IfValueT{#1}{\left(#1\right)}}
\NewDocumentCommand\streamderv{o}{\mathsf{d}\IfValueT{#1}{\left(#1\right)}}
