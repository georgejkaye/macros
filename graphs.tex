...
\newcommand{\hypsigmac}{\hyp_{\signature,C}}
...
\NewDocumentCommand\termtohypsigmac{o}{%
    \llbracket{\IfValueTF{#1}{#1}{-}}\rrbracket_{\Sigma,C}
}
...
\NewDocumentCommand\frobtohypsigmac{o}{%
    \left[{\IfValueTF{#1}{#1}{-}}\right]_{\Sigma,C}
}
...
\NewDocumentCommand\tracedtosymandfrobsigmas{o}{
    \left\lfloor\IfValueTF{#1}{#1}{-}\right\rfloor^\mathbf{T}_{\Sigma, C}
}
