...
\NewDocumentCommand\termtohypsigmas{o}{%
    \llbracket{\IfValueTF{#1}{#1}{-}}\rrbracket_{\Sigma,\mcs}
}
...
\NewDocumentCommand\frobtohypsigmas{o}{%
    \left[{\IfValueTF{#1}{#1}{-}}\right]_{\sigma,\mcs}
}
...
\NewDocumentCommand\tracedtosymandfrobsigmas{o}{
    \left\lfloor\IfValueTF{#1}{#1}{-}\right\rfloor^\mathbf{T}_{\Sigma, \mcs}
}
...
\NewDocumentCommand\tracedandcomonoidtofrobsigmas{o}{
    \left\lfloor\IfValueTF{#1}{#1}{-}\right\rfloor_{\Sigma, \mcs}
}
...
\NewDocumentCommand\termandfrobtohypsigmas{o}{%
    \llangle{\IfValueTF{#1}{#1}{-}}\rrangle_{\Sigma,\mcs}
}
