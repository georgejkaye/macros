...
% paths
\newcommand{\vpath}[2]{(#1, #2)}
\newcommand{\tracepath}[2]{(#1, #2)}
\newcommand{\tracerelation}{\sim}
\newcommand{\tracerelated}[2]{\tracerelation_{(#1,#2)}}
\newcommand{\tracerelclass}[3]{[#1]^{\sim}_{#2,#3}}
\newcommand{\tracerelclassfg}[1]{\tracerelclass{#1}{f}{g}}
