...
\newcommand{\circuitsignaturearity}{\mathsf{ar}}
...
\newcommand{\cartesiannat}{\mathcal{A}}
\newcommand{\closedcombequations}{\mathcal{C}}
\newcommand{\delayequations}{\mathcal{D}}
\newcommand{\tracefreeequations}{\mathcal{F}}
\newcommand{\instantfeedback}{\mathsf{IF}}
\newcommand{\streamperiod}{\mathsf{P}}
\newcommand{\circuitequations}{\mathcal{R}}
...
\NewDocumentCommand\eqaxioms{om}{%
    \IfValueTF{#1}{\stackrel{#1}{=}}{=_{#2}}
}
